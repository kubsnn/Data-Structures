...
public:
	...
	constexpr _Cycle(const _Container& _Val) 
		: _Data(_Val)
	{ }
...
{
	template <class _Container>
	constexpr _Cycle<_Container> operator()(const _Container& _C) const {
...
template <class _Container>
constexpr _Cycle<_Container> operator|(const _Container& _C, const cycle_fn& _Cycle) {
	return _Cycle(_C);
}